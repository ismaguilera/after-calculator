    ...
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
        ...
        <div className="space-y-8">
          <section>
            <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300 mb-4">Revenue Model</h3>
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300 mb-4">Operational Parameters</h3>
            <div className="space-y-4">
        ...
        <div className="space-y-8">
          <section>
            <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300 mb-4">Monthly Fixed Costs</h3>
        ...
        <div className="space-y-8">
          <section>
            <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300 mb-4">Monthly Variable Costs</h3>
            <div className="space-y-3">
